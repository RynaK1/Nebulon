...
const static int GO_MAIN_MENU = 1;
const static int GO_OPTIONS_MENU = 2;
const static int GO_GAMEPLAY = 3;
const static int GO_END = 4;
const static int GO_GAMEOVER = 5;
